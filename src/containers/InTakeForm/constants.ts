      ...
      While you may also pick up your medication at another pharmacy of your choice, the copay amount owed will differ from pharmacy to pharmacy, and be based on your insurance coverage.`,
        fields: [
          ...
          },
          {
            ...
            properties: [
              { path: "name", placeholder: "Name of the pharmacy", xs: 6 },
              { path: "phoneNumber", placeholder: "Phone number", xs: 6 },
              {
                path: "streetAddress1",
              ...
              { path: "city", placeholder: "City", xs: 6 },
              { path: "zipcode", placeholder: "Zipcode", xs: 6 },
              {
                path: "state",
                placeholder: "Zipcode",
                type: FieldType.SELECT,
        ...
        fields: [
          ...
          },
          {
            ...
            properties: [
              ...
              { path: "name", placeholder: "Name of the person", xs: 6 },
              {
                path: "streetAddress1",
                placeholder: "Street address 1",
                xs: 6,
